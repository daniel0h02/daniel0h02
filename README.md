...
- Jira를 활용한 일정 및 담당 기능 관리
- 데일리 스크럼을 통한 진행 상황 및 이슈 공유
- 요구사항 정의서, 기능 명세서, API 명세서, ERD 기반 개발 경험
- Git 기반 협업 및 브랜치 관리 경험
- FastAPI 기반 AI 서버와 백엔드 서비스 연동 경험
- RDB 조건 검색과 Vector 유사도 검색을 결합한 검색 기능 구현 경험
